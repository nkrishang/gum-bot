...
export const m = {
  ...
  payLatency: new Histogram({
    ...
    help: 'Mover transfer broadcast → landed (block timestamp)',
    labelNames: ['chain'],
    buckets: secs,
  }),
  detectLatency: new Histogram({
    ...
    help: 'Payment landed (block timestamp) → Gum detected_at',
    labelNames: ['chain'],
    buckets: secs,
  }),
  settleLatency: new Histogram({
    ...
    help: 'Payment landed (block timestamp) → Gum settled_at: the headline latency',
    labelNames: ['chain'],
    buckets: secs,
  }),
